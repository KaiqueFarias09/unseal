...
Map<String, Object?> encodeNavigationWireValue(final Navigation navigation) {
...
Map<String, Object?> _encodeNavPoint(final NavPoint point) {
  return <String, Object?>{
...
Navigation decodeNavigationWireValue(final Map<String, Object?> json) {
  return Navigation(
...
NavPoint _decodeNavPoint(final Map<String, Object?> json) {
  return NavPoint(
...
Files decodeFilesWireValue(final Map<String, Object?> json, final List<Object> blobs) {
  return Files(
...
TextFile _decodeTextFile(final Map<String, Object?> json, final List<Object> blobs) {
  return TextFile(
...
List<TextFile> _decodeTextFiles(final List<Object?> json, final List<Object> blobs) {
  return <TextFile>[for (final file in json) _decodeTextFile(file as Map<String, Object?>, blobs)];
}
...
BinaryFile decodeBinaryFileWireValue(final Map<String, Object?>? json, final List<Object> blobs) {
  if (json == null) return BinaryFile.empty();
...
List<ArchiveEntry> decodeArchiveEntriesWireValue(final List<Object?> json) {
  return <ArchiveEntry>[
