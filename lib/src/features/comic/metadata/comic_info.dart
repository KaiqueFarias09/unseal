...
/// Partial metadata extracted from an embedded `ComicInfo.xml` (the de-facto ComicRack schema).
class ComicInfo {
  ...
  /// Parses the [xml] document. Returns `null` when the root element is not a `ComicInfo` document.
