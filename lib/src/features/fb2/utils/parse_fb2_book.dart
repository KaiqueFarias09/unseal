...
import 'package:e_livre/src/features/fb2/entities/entities.dart';
import 'package:e_livre/src/features/fb2/exceptions/exceptions.dart';
...
Fb2Book parseFb2Book(final Uint8List bytes) {
  if (bytes.length > 2 && bytes[0] == 0x50 && bytes[1] == 0x4B) {
    ...
    for (final file in archive.files) {
      if (file.isFile && file.name.toLowerCase().endsWith('.fb2')) return parseFb2Archive(file);
    }
